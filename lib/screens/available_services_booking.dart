...
// class AvailableServicesBookingPage extends StatefulWidget {
//   const AvailableServicesBookingPage({super.key, required Map barber});

//   @override
//   // ignore: library_private_types_in_public_api
//   _AvailableServicesBookingPageState createState() => _AvailableServicesBookingPageState();
// }

// class _AvailableServicesBookingPageState extends State<AvailableServicesBookingPage> {
...
//   final List<Map<String, dynamic>> _selectedServices = []; // List to store selected services
...
//     {'name': 'Barber 1', 'duration': 30, 'price': 15.0},
//     {'name': 'Barber 2', 'duration': 15, 'price': 10.0},
//     {'name': 'Barber 3', 'duration': 15, 'price': 10.0},
//     {'name': 'Barber 4', 'duration': 45, 'price': 25.0},
//     {'name': 'Barber 5', 'duration': 35, 'price': 20.0},
//   ];
// }
...
class AvailableServicesBookingPage extends StatefulWidget {
  const AvailableServicesBookingPage({super.key});
  ...
  Future<void> _confirmBooking() async {
    if (_formKey.currentState!.validate()) {
      if (_selectedBarberId == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Please select a barber')),
        );
        return;
      }

      // Perform the booking logic here using _selectedBarberId, _selectedDateTime, etc.
      // For example, save the booking to Firestore or any other database.
